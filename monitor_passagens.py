...
VERIFICAR_HORAS = 3       # a cada 6 horas
...
#  Hubs europeus com dados na API + destinos com dados diretos
# ============================================================
DESTINOS = [
...
def verificar_todos():
    ...
    # Separa Dublin (foco principal) dos hubs e demais
    ...
    if dublin:
        msg += (
            ...
            f"   🏢 {dublin['cia']}\n"
            f"   💡 De Dublin você chega em Tallinn por ~€50-150\n"
        )
        msg += "\n━━━━━━━━━━━━━━━━━━━━\n\n"
 
    # Hubs com conexão para Tallinn
    if hubs:
...
if __name__ == "__main__":
    ...
    enviar_telegram(
        ...
        f"🔵 Hubs monitorados: FRA, IST, ARN, HEL, RIX, WAW\n"
